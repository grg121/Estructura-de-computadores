...
main: .global main
  ...
  */
  ...
  /**
   ** $eax contiene la parte menos significativa de resultado,
   ** %edx la más significativa. Para concatenar %eax y %ebx
   ** en resultado movemos %eax a resultado
   ** y luego %edx 4B por delante (resultado + 4 )
